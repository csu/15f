      ...
      <section className='SponsorSection page-section' id='sponsor'>
        ...
        <div className='tiers'>
          ...
          <ul className='gold'>
            ...
            <li><a href="http://a16z.com/" target="_blank"><img ref='img' src='images/company_logos/a16z.svg' /></a></li>
          ...
          <ul className='bronze'>
            ...
            <li><a href="https://www.tune.com/" target="_blank"><img ref='img' src='images/company_logos/tune.png' /></a></li>
          </ul>
          <h2 className='section title'>Partners</h2>
          <ul className='partners'>
            <li><a id="mlh-trust-badge" href="https://mlh.io/?utm_campaign=Trust%20Badge" target="_blank"><img src="https://s3.amazonaws.com/logged-assets/trust-badge/f2015.png" alt="MLH Official - Fall 2015" style={{ width: "160px" }} /></a></li>
          </ul>
        </div>
